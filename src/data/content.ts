...
// Nội dung giới thiệu nguyên bản 100% từ link gốc fit-huce.github.io/ttvf18/Home.html
export const ABOUT_ORIGINAL_TEXT = 
  'Đội SVTN Khoa Công Nghệ Thông Tin - Đại học Xây Dựng Hà Nội được thành lập vào năm 2006. Trải qua thời gian dài hình thành, hoạt động và phát triển, hiện tại FIT đang là thế hệ thứ 17. Đội là 1 tổ chức có tính kỉ luật, hoạt động sôi nổi với nhiều chương trình tình nguyện, tổ chức gây quỹ, các buổi thiện nguyện, hỗ trợ các phường, ban xã nhằm tạo ra giá trị tốt đẹp cho cộng đồng và xã hội. Đây còn là nơi để các thành viên giao lưu, học hỏi nhiều điều từ các anh chị thế hệ đi trước, hoàn thiện hơn cả trong học tập và kĩ năng sống. Mỗi thành viên trong Đội đều là những con người nhiệt huyết, năng động và luôn luôn sẵn sàng giúp đỡ mọi người khó khăn. Đặc biệt là mỗi cá nhân đều mang 1 một bản sắc riêng cực kì cá tính và tài năng. Quan trọng nhất và cũng là điều tự hào của Đội đó là tinh thần vượt khó, luôn luôn cố gắng hoàn thành mọi mục tiêu trong mỗi chương trình đặt ra. Các thành viên luôn cố gắng mang lại thật nhiều điều mới lạ, thật nhiều điều tốt đẹp để khiến thanh xuân trở nên thật đáng nhớ.';

export const HIGHLIGHT_STATS = [
  {
    label: 'Năm thành lập',
    value: '2006',
    description: 'Hơn 18 năm cống hiến vì cộng đồng',
    icon: 'Flag',
  },
  {
    label: 'Thế hệ phát triển',
    value: '18+',
    description: 'Tuyển CTV F18 nối tiếp truyền thống',
    icon: 'Flame',
  },
  {
  ...
  },
  {
    ...
    description: 'Học hỏi kỹ năng sống và chuyên môn CNTT',
    icon: 'HeartHandshake',
  },
];
...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  },
  {
    ...
    caption: 'Chào đón các bạn Tân sinh viên - Những mảnh ghép tiếp theo của F18',
    url: 'https://fit-huce.github.io/ttvf18/images/7.jpg',
    tag: 'Thế hệ F18',
  },
];

// Timeline tuyển thành viên TTVF18
export const RECRUITMENT_TIMELINE: TimelineStep[] = [
  {
    step: 1,
    title: 'Vòng 1: Mở Đơn Đăng Ký Online',
    time: 'Đang diễn ra',
    description: 'Điền thông tin và chia sẻ nguyện vọng qua Google Form chính thức của Đội.',
    status: 'current',
  },
  {
    step: 2,
    ...
    description: 'Buổi trò chuyện thân thiện giúp Đội hiểu rõ hơn về tính cách, định hướng và sở trường của bạn.',
    status: 'upcoming',
  },
  {
    step: 3,
    title: 'Vòng 3: Thử Thách Tân CTV & Trải Nghiệm',
    time: 'Giai đoạn tập sự',
    description: 'Cùng tham gia các hoạt động tiền sự kiện, làm quen đồng đội và làm quen môi trường làm việc.',
    status: 'upcoming',
  },
  {
    step: 4,
    title: 'Vòng 4: Họp Mặt Chính Thức & Ra Mắt F18',
    time: 'Gala Chào đón',
    description: 'Chính thức khoác lên mình màu áo xanh tình nguyện FIT - HUCE và nhận thẻ CTV thế hệ mới!',
    status: 'upcoming',
  },
];
